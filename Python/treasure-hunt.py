...
print("You are standing in front of two roads. The left road looks dangerous, while the right one looks safe.")
first = input('Left or Right? L | R ')

if(first == 'L' or first == 'l'):
    print("You get to the end of the road and find a lake. You see something moving underwater.")
